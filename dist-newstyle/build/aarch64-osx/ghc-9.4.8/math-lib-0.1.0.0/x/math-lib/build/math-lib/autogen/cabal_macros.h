...
/* package math-lib-0.1.0.0 */
#ifndef VERSION_math_lib
#define VERSION_math_lib "0.1.0.0"
#endif /* VERSION_math_lib */
#ifndef MIN_VERSION_math_lib
#define MIN_VERSION_math_lib(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_math_lib */
...
#define CURRENT_COMPONENT_ID "math-lib-0.1.0.0-inplace-math-lib"
